...
The REST API documentation can be found [on docs.meorphis-test-28-st1ky2.com](https://docs.meorphis-test-28-st1ky2.com). The full API of this library can be found in [api.md](api.md).
...
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/meorphis-test/test-repo-14/tree/main/src/_shims#readme)).
